            ...
            <div class="container-fluid">
                        ...
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="{{ route('infos.index') }}" title="Quản lý thông tin" data-toggle="tooltip" data-placement="top">Quản lý thông tin</a></li>
                ...
                <div class="row">
                    <div class="col-12">
                                ...
                                <form method="POST" action="{{ route('infos.update', $data_edit->id) }}" enctype="multipart/form-data">
                                    @method('PUT')
                                    @include('info._form')
